...
export const patients = [
  { id: '0123456', name: 'นายสมชาย ใจดี', age: 68, sex: 'ชาย', abbrev: 'TKA', procedure: 'Total Knee Arthroplasty (R)', surgeon: 'นพ. อธิวัฒน์ ศรีกมล', department: 'ศัลยกรรมกระดูก', surgeryDate: '10 มิ.ย. 2569', followUp: '15 มิ.ย. 2569', status: 'รอตรวจสอบ', risk: 'ปานกลาง' },
  { id: '0123457', name: 'นายภาคิน พิทักษ์อนันต์', age: 42, sex: 'ชาย', abbrev: 'TKA', procedure: 'Total Knee Arthroplasty (L)', surgeon: 'นพ. อธิวัฒน์ ศรีกมล', department: 'ศัลยกรรมกระดูก', surgeryDate: '10 มิ.ย. 2569', followUp: '15 มิ.ย. 2569', status: 'กำลังติดตาม', risk: 'ต่ำ' },
  { id: '0123458', name: 'นางสาววิภาพร คำดี', age: 63, sex: 'หญิง', abbrev: 'THA', procedure: 'Total Hip Arthroplasty', surgeon: 'นพ. อธิวัฒน์ ศรีกมล', department: 'ศัลยกรรมกระดูก', surgeryDate: '10 มิ.ย. 2569', followUp: 'วันนี้', status: 'ครบกำหนดวันนี้', risk: 'สูง' },
  { id: '0123459', name: 'นายกรกนก พิพัฒน์เมธา', age: 43, sex: 'ชาย', abbrev: 'TKA', procedure: 'Total Knee Arthroplasty (R)', surgeon: 'นพ. กมลชนก อัศวรุ่งโรจน์', department: 'ศัลยกรรมกระดูก', surgeryDate: '10 มิ.ย. 2569', followUp: '14 มิ.ย. 2569', status: 'ติดตามเสร็จแล้ว', risk: 'ต่ำ' },
  { id: '0456789', name: 'นายอนันต์ รัตนกุล', age: 70, sex: 'ชาย', abbrev: 'Spine Fixation', procedure: 'Posterior Lumbar Spine Fixation', surgeon: 'นพ. กมลชนก อัศวรุ่งโรจน์', department: 'ศัลยกรรมกระดูกสันหลัง', surgeryDate: '10 มิ.ย. 2569', followUp: '13 มิ.ย. 2569', status: 'เกินกำหนด', risk: 'สูง' },
  { id: '0456790', name: 'นางฉัตรดาว เพชรดี', age: 48, sex: 'หญิง', abbrev: 'Appendectomy', procedure: 'Laparoscopic Appendectomy', surgeon: 'พญ. สุภาวดี จันทร์แก้ว', department: 'ศัลยกรรมทั่วไป', surgeryDate: '9 มิ.ย. 2569', followUp: '16 มิ.ย. 2569', status: 'สงสัย SSI', risk: 'สูง' },
  { id: '0456791', name: 'นางนิตยา เจริญสุข', age: 55, sex: 'หญิง', abbrev: 'THA', procedure: 'Total Hip Arthroplasty', surgeon: 'นพ. อธิวัฒน์ ศรีกมล', department: 'ศัลยกรรมกระดูก', surgeryDate: '7 มิ.ย. 2569', followUp: '16 มิ.ย. 2569', status: 'ยืนยัน SSI', risk: 'สูง' },
]
